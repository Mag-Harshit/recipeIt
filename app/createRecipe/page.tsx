  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link href="/">
          <button className="mr-5 text-lg h-14 bg-gray-400 text-white transition-all hover:bg-white hover:text-black border-black border-[1px] rounded-xl px-2">
            Home
          </button>
        </Link>
      </div>
      <div>
        ...
        <div className="mt-10 gap-10 flex flex-col justify-center items-center ">
          <div className="flex flex-col  gap-2">
            ...
            <input
              type="text"
              className="w-96 rounded-md h-11 p-2 text-lg border-black border-[1px]"
            />
          </div>
            ...
            {ingredients.map((ingred, index) => (
              <div key={ingred.id} className="flex  gap-4">
                <div className="flex flex-row gap-3">
                  <input
                    value={ingred.value}
                    className=" w-80 rounded-md h-11 p-2 text-lg border-black border-[1px]"
                    onChange={(e) => {
      ...
      <div className="text-right mr-5">
        <button
          className="text-2xl mt-10 transition-all p-3 rounded-xl border-black border-[1px] hover:bg-black hover:text-white"
